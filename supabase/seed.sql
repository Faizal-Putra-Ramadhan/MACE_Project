...
VALUES ('admin@mace.go.id', '$2b$10$7qB2T8.6nC8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8', 'admin', true)
ON CONFLICT (email) DO UPDATE SET is_approved = true, role = 'admin';

-- User John
INSERT INTO "users" (email, password, role, is_approved) 
VALUES ('john@gmail.com', '$2b$10$7qB2T8.6nC8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8', 'mahasiswa', true)
ON CONFLICT (email) DO NOTHING;

-- User Faizal (Data Collector)
INSERT INTO "users" (email, password, role, is_approved) 
VALUES ('faizal@gmail.com', '$2b$10$7qB2T8.6nC8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8Y7.8', 'mahasiswa', true)
ON CONFLICT (email) DO NOTHING;
