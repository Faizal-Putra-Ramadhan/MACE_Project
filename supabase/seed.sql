...
VALUES ('admin@mace.go.id', '$2b$10$mC3msT6YUXsSgtMOPDlsf.7Z7F.XvS7oG6ZpGZpGZpGZpGZpGZpG', 'admin', true)
ON CONFLICT (email) DO UPDATE SET is_approved = true, role = 'admin', password = EXCLUDED.password;

-- User John
INSERT INTO "users" (email, password, role, is_approved) 
VALUES ('john@gmail.com', '$2b$10$mC3msT6YUXsSgtMOPDlsf.7Z7F.XvS7oG6ZpGZpGZpGZpGZpGZpG', 'mahasiswa', true)
ON CONFLICT (email) DO UPDATE SET password = EXCLUDED.password;

-- User Faizal (Data Collector)
INSERT INTO "users" (email, password, role, is_approved) 
VALUES ('faizal@gmail.com', '$2b$10$mC3msT6YUXsSgtMOPDlsf.7Z7F.XvS7oG6ZpGZpGZpGZpGZpGZpG', 'mahasiswa', true)
ON CONFLICT (email) DO UPDATE SET password = EXCLUDED.password;
